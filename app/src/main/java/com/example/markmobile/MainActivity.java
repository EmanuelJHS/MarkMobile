...
import com.example.markmobile.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    //public  final MyBD bd = new MyBD(this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Creando Data Base
       MyBD bd = new MyBD(this);
        //System.out.println(Utilities.CREATE_TABLE_MARCACION);
        bd.getWritableDatabase(); //Abrir base de datos
